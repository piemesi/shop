...
@section('main_category')
    <div class="main_category">
        ...
        {{--<div class="category_item cat_1 waves-effect waves-black" style="background:#000 url(/main_catalog/jewelry.jpg) no-repeat 50% 50% / cover"><a href="/catalog/accessory/"><span>Украшения</span></a></div>--}}
        {{--<div class="category_item cat_2 waves-effect waves-black" style="background:#000 url(/main_catalog/stole.jpg) no-repeat 50% 50% / cover"><a href="/catalog/neck/"><span>Плантины платки</span></a></div>--}}
